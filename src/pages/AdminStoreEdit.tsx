...
const AdminStoreEdit: React.FC<{ currentUser: User | null }> = ({ currentUser }) => {
  ...
  // 🔴 페이지 진입 시 데이터 로드 (인증은 상위 AdminRoute가 보장함)
  useEffect(() => {
    fetchStore();
  }, [id]);
  ...
  return (
    <div className="min-h-screen bg-[#050505] pt-32 pb-20 px-6 font-sans">
      <div className="max-w-5xl mx-auto bg-[#111] rounded-[3.5rem] p-10 md:p-16 border border-white/5 shadow-2xl text-white">
        <header className="text-center mb-16">
          <h2 className="text-5xl font-black italic uppercase tracking-tighter inline-block border-b-8 border-emerald-500 pb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="md:col-span-2 space-y-4">
              <label className="text-sm font-black text-gray-400 uppercase tracking-widest ml-2">🖼️ 갤러리 관리</label>
