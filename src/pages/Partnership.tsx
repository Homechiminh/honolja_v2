  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 bg-white min-h-screen">
      ...
      <div className="text-center mb-20">
        <h2 className="text-blue-600 font-bold mb-4 tracking-widest text-xl uppercase italic">Vietnam No.1 Platform</h2>
        <h1 className="text-4xl md:text-6xl font-black text-gray-900 mb-8 leading-tight break-keep">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
        ...
        <div className="group p-10 rounded-[2.5rem] border-2 border-gray-100 hover:border-blue-500 transition-all duration-300 shadow-sm hover:shadow-2xl bg-white">
          <div className="bg-blue-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
            <span className="text-3xl group-hover:scale-110 transition-transform text-blue-600">🏢</span>
          </div>
        ...
        <div className="group p-10 rounded-[2.5rem] border-2 border-gray-100 hover:border-orange-500 transition-all duration-300 shadow-sm hover:shadow-2xl bg-white">
          <div className="bg-orange-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-orange-500 transition-colors">
            <span className="text-3xl group-hover:scale-110 transition-transform text-orange-500">🚀</span>
          </div>
      ...
      {/* 하단 CTA Section */}
      <div className="bg-blue-600 rounded-[3rem] p-12 text-center text-white shadow-2xl">
        <h3 className="text-3xl font-black mb-4 tracking-tight">상담은 24시간 열려있습니다</h3>
        <p className="mb-10 text-blue-100 text-lg font-medium italic">텔레그램 고객센터 @honolja84</p>
        <a 
          href={TELEGRAM_URL} 
          target="_blank" 
          rel="noopener noreferrer"
          className="inline-block px-16 py-5 bg-white text-blue-600 rounded-2xl font-black text-xl hover:bg-gray-100 transition-all shadow-xl"
        >
          지금 바로 상담하기
        </a>
      </div>
