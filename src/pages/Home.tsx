...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#050505] relative overflow-hidden selection:bg-red-600/30">
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-2 flex lg:flex-col gap-4">
          <a href="https://t.me/honolja" target="_blank" rel="noreferrer" className="flex-1 bg-[#0088cc] rounded-[2rem] p-8 relative overflow-hidden group hover:scale-[1.03] transition-all shadow-xl">
            ...
            <h4 className="text-xl font-black italic text-white leading-tight">호놀자 텔레그램</h4>
          </a>
          <a href="https://open.kakao.com/o/gx4EsPRg" target="_blank" rel="noreferrer" className="flex-1 bg-[#FEE500] rounded-[2rem] p-8 relative overflow-hidden group hover:scale-[1.03] transition-all text-black shadow-xl">
            ...
            <h4 className="text-xl font-black italic leading-tight">호놀자 단톡방</h4>
          </a>
        </div>
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-24">
        <div className="bg-[#080808] rounded-[3rem] p-12 border border-white/5 relative overflow-hidden shadow-2xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12 relative z-10 px-4">
            <div><h3 className="text-4xl font-black italic mb-2 tracking-tighter text-white uppercase leading-none">Premium Stays</h3><p className="text-gray-500 font-bold text-sm md:text-base">호놀자가 검증한 최고급 풀빌라와 차량 서비스</p></div>
      ...
      {/* [신규 섹션] 광고 배너 섹션 - Premium Stays와 Footer 사이 */}
      <section className="max-w-[1400px] mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* 광고 1 */}
          <div className="bg-[#111] border border-white/5 rounded-[2rem] p-10 flex flex-col justify-center items-center text-center group hover:border-red-600/30 transition-all duration-500">
            <span className="text-red-600 font-black text-[10px] uppercase tracking-[0.3em] mb-4 italic">Partnership</span>
            <h4 className="text-white text-xl md:text-2xl font-black italic tracking-tighter break-keep">
              호놀자와 함께하실 <br/> 광고주분들의 연락을 기다립니다.
            </h4>
          </div>
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-white/5 rounded-[2rem] p-10 flex flex-col justify-center items-center text-center group hover:scale-[1.02] hover:border-blue-500/30 transition-all duration-500"
          >
            ...
            <h4 className="text-white text-xl md:text-2xl font-black italic tracking-tighter mb-4">
              호놀자 광고제휴 텔레그램 <br/> <span className="text-blue-400">@honolja84</span>
            </h4>
            <div className="px-6 py-2 bg-blue-600/10 border border-blue-600/20 rounded-full text-blue-400 text-xs font-black uppercase tracking-widest italic group-hover:bg-blue-600 group-hover:text-white transition-all">
              Contact Now
            </div>
          </a>
        </div>
